    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col  form-inline">
                ...
                <?php PYS()->render_select_input( 'woo_add_to_cart_on_single_product',
                    array('add_cart_hook'=>"Hook",
                ...
                <div class="custom-controls-stacked ml-2">
                    <?php
                        ...
                        foreach ( $statuses as $status => $status_name) {
                            PYS()->render_checkbox_input( 'woo_order_purchase_status_'.esc_attr( $status ), esc_html( $status_name ));
                        }
                    ?>
                </div>
